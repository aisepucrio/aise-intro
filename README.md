# Bem-vindo ao Repositório de Introdução do AISE Lab
...
### Exemplos de Pastas:
- `aise-stnl-intro`: Contém informações sobre o StoneLab, incluindo padrões de nomenclatura para projetos como o EvoMLearn.
